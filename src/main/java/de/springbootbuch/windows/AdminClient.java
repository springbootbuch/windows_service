...
public class AdminClient {
    ...
    AdminClient(final MBeanServerConnection connection, final String jmxName) {
     ...
     */
    public static JMXConnector connect(final int port) throws IOException {
        final String url = "service:jmx:rmi:///jndi/rmi://127.0.0.1:" + port + "/jmxrmi";
